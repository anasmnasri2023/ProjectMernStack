...
const DataStatsThree = () => {
  return (
    <div>
      ...
      <div
              className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6 xl:grid-cols-3 2xl:gap-7.5"
            >
              <div
              ...
              >
                <div className="flex items-end justify-between">
                  <div>
                    <h3
                      className="mb-4 text-title-lg font-bold text-black dark:text-white"
                    >
                      197
                    </h3>
                    ...
                    <span className="mt-2 flex items-center gap-2">
                      <span
                        className="flex items-center gap-1 rounded-md bg-meta-3 p-1 text-xs font-medium text-white"
                      >
                        <svg
                          width="14"
                          height="15"
              ...
              >
                <div className="flex items-end justify-between">
                  <div>
                    ...
                    <span className="mt-2 flex items-center gap-2">
                      <span
                        className="flex items-center gap-1 rounded-md bg-red p-1 text-xs font-medium text-white"
                      >
                        <svg
                          width="14"
                          height="15"
                  ...
                  <div>
                    <svg className="h-17.5 w-17.5 -rotate-90 transform">
                      ...
                      <circle
                        ...
                        strokeWidth="10"
                        strokeDasharray={30 * 2 * Math.PI}
                        strokeDashoffset={30 * 2 * Math.PI - 70 / 100 * 30 * 2 * Math.PI}
                        strokeLinecap=""
                        stroke="currentColor"
                        fill="transparent"
                        r="30"
