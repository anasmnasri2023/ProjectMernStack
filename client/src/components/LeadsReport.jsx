        ...
        <div className='p-4 md:p-6 xl:p-7.5'>
          <div className='flex flex-col gap-7'>
            <div className='flex items-center gap-3'>
              ...
              <div className='w-4/12 2xsm:w-3/12 md:w-2/12 xl:w-1/12'>
                <span className='inline-block rounded bg-red/[0.08] py-0.5 px-2.5 text-sm font-medium text-red'>
                  Lost Lead
                </span>
              </div>
            ...
            <div className='flex items-center gap-3'>
              ...
              <div className='w-4/12 2xsm:w-3/12 md:w-2/12 xl:w-1/12'>
                <span className='inline-block rounded bg-meta-3/[0.08] py-0.5 px-2.5 text-sm font-medium text-meta-3'>
                  Active
                </span>
              </div>
              <div className='hidden w-2/12 2xsm:block md:w-1/12'>
