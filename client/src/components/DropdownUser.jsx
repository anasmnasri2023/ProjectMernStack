  ...
  useEffect(() => {
    const fetchData = async () => {
      await axios.get(`/api/users/${user.id}`).then((res) => {
        dispatch(_setCurrentUser(res.data));
      });
    };
    fetchData();
  }, []);
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <button className="flex items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out hover:text-secondary lg:text-base">
          <button
