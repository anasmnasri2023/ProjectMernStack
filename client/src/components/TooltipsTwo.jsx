  ...
  return (
    <div className='rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark'>
      <div className='border-b border-stroke px-4 py-4 dark:border-strokedark sm:px-6 xl:px-7.5'>
        <h3 className='font-medium text-black dark:text-white'>Tooltips Style 2</h3>
      </div>
          ...
          <div className='w-full px-4 sm:w-1/2 xl:w-1/4'>
            <div className='mb-14'>
              <div className='group relative inline-block'>
                ...
                <div className='absolute left-full top-1/2 z-20 ml-3 -translate-y-1/2 whitespace-nowrap rounded-md bg-white py-1.5 px-4.5 text-sm font-medium opacity-0 drop-shadow-4 group-hover:opacity-100 dark:bg-meta-4'>
          ...
          <div className='w-full px-4 sm:w-1/2 xl:w-1/4'>
            <div className='mb-14'>
              <div className='group relative inline-block'>
                ...
                <div className='absolute top-full left-1/2 z-20 mt-3 -translate-x-1/2 whitespace-nowrap rounded-md bg-white py-1.5 px-4.5 text-sm font-medium opacity-0 drop-shadow-4 group-hover:opacity-100 dark:bg-meta-4'>
          ...
          <div className='w-full px-4 sm:w-1/2 xl:w-1/4'>
            <div className='mb-14 text-right sm:text-left'>
              <div className='group relative inline-block'>
                ...
                <div className='absolute right-full top-1/2 z-20 mr-3 -translate-y-1/2 whitespace-nowrap rounded-md bg-white py-1.5 px-4.5 text-sm font-medium opacity-0 drop-shadow-4 group-hover:opacity-100 dark:bg-meta-4'>
